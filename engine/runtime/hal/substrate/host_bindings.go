...
var goHostProvenance = map[string]string{
	...
	"_io_close":          "go:runtime-owned io.Closer",
	"_sleep":             "go:time.Sleep",
	"_after":             "go:time.AfterFunc/value.NewEventChannel",
	"_system_args":       "go:runtime-owned programArgs",
	"_system_env":        "go:runtime-owned environment map lookup",
	"_system_environ":    "go:runtime-owned environment snapshot",
	"_system_set_env":    "go:runtime-owned environment map mutation",
	"_system_unset_env":  "go:runtime-owned environment map mutation",
	...
	"_file_lock":         "go:github.com/gofrs/flock.Lock",
	"_file_try_lock":     "go:github.com/gofrs/flock.TryLock",
	"_file_unlock":       "go:github.com/gofrs/flock.Unlock",
	...
	"_term_is":           "go:github.com/chzyer/readline.IsTerminal",
	"_term_size":         "go:github.com/chzyer/readline.GetSize",
	"_term_raw":          "go:github.com/chzyer/readline.MakeRaw",
	"_term_restore":      "go:github.com/chzyer/readline.Restore",
	"_system_exec":       "go:os/exec.Command + pipes/wait",
	"_process_start":     "go:os/exec.Cmd.Start + StdinPipe/StdoutPipe/StderrPipe",
	"_process_stdin":     "go:runtime-owned process stdin endpoint",
	"_process_stdout":    "go:runtime-owned process stdout endpoint",
	"_process_stderr":    "go:runtime-owned process stderr endpoint",
	"_process_wait":      "go:os/exec.Cmd.Wait",
	"_process_terminate": "go:os.Process.Kill",
	"_net_connect":       "go:net.Dial(tcp)",
	"_net_listen":        "go:net.Listen(tcp)",
	"_net_accept":        "go:net.Listener.Accept",
	"_net_local":         "go:net.Addr local endpoint metadata",
	"_net_remote":        "go:net.Conn.RemoteAddr",
	"_net_close":         "go:net.Listener/UDPConn.Close",
	"_net_udp_bind":      "go:net.ListenUDP",
	"_net_udp_send":      "go:net.UDPConn.WriteToUDP",
	"_net_udp_recv":      "go:net.UDPConn.ReadFromUDP",
	"_signal_watch":      "go:os/signal.Notify + value.NewEventChannel",
	"_signal_stop":       "go:os/signal.Stop",
	"_signal_send":       "go:os.Process.Signal/Kill portable mapping",
}
