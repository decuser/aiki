...
var nonHALRoles = map[string]Role{
	...
	"_bytes_digits_from_text": RoleNative,
	"_bytes_digits_to_text":   RoleNative,
	"_shape":                  RoleNative,
	...
	"_store_snapshot":         RoleNative,
	"_store_digits_to_text":   RoleNative,
	"_store_checksum":         RoleNative,
