...
HIST Embedded grammar via go embed. [engine/syntax/definition/grammar.ebnf]
HIST Introduced definition.New as canonical loader returning GrammarContract. [engine/syntax/definition/definition.go New]
HIST Updated tools and tests to use GrammarContract. [tools and tests]
...
WHY GrammarContract interface decouples grammar definition from parser implementation.
