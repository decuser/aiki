...
// DefaultScheduler is the package-level scheduler used by concurrency builtins.
...
func init() {
	builtins["channel"] = &value.Builtin{
		Name: "channel",
